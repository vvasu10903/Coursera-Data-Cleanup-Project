...
#	Basic approach to cleaning the variable names is that variables are transformed into Camel Case		#	notation because the names are very long and has several words connected to each other which cannot #	be read clearly. Variable names are made more readable by making the first letter of the word
